...
class Detailed_receivings extends Report
{
	...
	public function getData(array $inputs)
	{
		...
		{
			$this->db->select('name, item_number, definition_name AS category, quantity_purchased, serialnumber, total, discount_percent, item_location, receivings_items_temp.receiving_quantity');
			$this->db->from('receivings_items_temp');
